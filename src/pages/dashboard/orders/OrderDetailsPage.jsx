...
export const OrderDetailsPage = () => {
    ...
    const { isLoadingOrder, products, status, date, delivery, total, discount, reviews, nameFact, dni, address, phone } = useSelector((state) => state.order);
    ...
    const handleBill = () => {
        ...
        autoTable(doc, {
            ...
            didDrawPage: (HookData) => {
                ...
                doc.setFontSize(9);
                doc.text(`Pagina ${HookData.pageNumber} / ${HookData.pageCount}`, 10, 290);
                doc.text(`DESCUENTO: ${discount}%`, 120, 290);
                doc.text(`TOTAL: ${formatNumber(total, "EN-US", "USD")}`, 160, 290);
            },
        });
        ...
        doc.text(`NOTIFICACION #${id.substr(0, 8).toUpperCase()}`, 153, 18);
